    ...
    <section className="section">
      <div className="benefit-section">
        ...
        <div className="benefit-container">
          ...
          <div className="benefit-card">
            <div className="benefit-card-image">
              <i className="hgi-stroke hgi-laurel-wreath-02" />
            </div>
            <div className="benefit-card-details">
              <div className="benefit-card-heading">
          ...
          <div className="benefit-card">
            <div className="benefit-card-image">
              <i className="hgi-stroke hgi-magic-wand-01" />
            </div>
            <div className="benefit-card-details">
              <div className="benefit-card-heading">
          ...
          <div className="benefit-card">
            <div className="benefit-card-image">
              <i className="hgi-stroke hgi-blockchain-03" />
            </div>
            <div className="benefit-card-details">
              <div className="benefit-card-heading">
          ...
          <div className="benefit-card">
            <div className="benefit-card-image">
              <i className="hgi-stroke hgi-blockchain-06" />
            </div>
            <div className="benefit-card-details">
              <div className="benefit-card-heading">
          ...
          <div className="benefit-card">
            <div className="benefit-card-image">
              <i className="hgi-stroke hgi-door-01" />
            </div>
            <div className="benefit-card-details">
              <div className="benefit-card-heading">
          ...
          {/* <div className="benefit-card">
            ...
            <div className="benefit-card-details">
              ...
              <div className="benefit-card-description">
                <p>
                  Personalized designs crafted to perfectly match your unique
